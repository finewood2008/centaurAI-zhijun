...
<template>
  <main class="page charter-page">
    <p class="charter-page__intro">本体记录知君对你的理解，章程写下你自己的方向与约定。</p>
    <SelfSections />
    ...
    <section class="charter-page__panel" aria-labelledby="charter-heading">
      <header class="charter-page__masthead">
        ...
        <div class="charter-page__title">
          ...
          <h1 id="charter-heading">人生章程</h1>
          <p>由你亲自确认的长期方向与合作约定。只有你主动修改并确认，新的章程才会生效。</p>
        </div>
...
.charter-page__intro { margin:0 0 14px; color:var(--ws-text-secondary-color); font-size:14px; line-height:1.75; }
.charter-page__panel { position:relative; overflow:hidden; padding:24px clamp(20px,4vw,46px) 28px; border:1px solid #d7cdbd; border-radius:4px; background:linear-gradient(145deg,#fbf7ee 0%,#f5efe3 100%); box-shadow:0 18px 52px rgba(58,44,29,.09); line-height:1.8; }
...
.charter-page__title h1 { margin:0 0 6px; font:600 clamp(29px,3.3vw,38px)/1.2 var(--ws-font-display); letter-spacing:.08em; }
.charter-page__title p { margin:0; color:var(--ws-text-secondary-color); font-size:14px; }
.charter-page__edition { display:grid; justify-items:end; gap:6px; text-align:right; }
.charter-page__state { display:inline-flex; align-items:center; gap:7px; padding:4px 8px; border:1px solid rgba(74,124,89,.45); color:var(--ws-success-color); background:rgba(255,255,255,.36); font-size:13px; font-weight:600; letter-spacing:.04em; }
...
.charter-page__version { color:var(--ws-text-secondary-color); font-size:12px; font-variant-numeric:tabular-nums; }
.charter-page__rule { position:relative; z-index:1; display:grid; grid-template-columns:1fr auto 1fr; align-items:center; gap:10px; margin:18px 0 16px; color:rgba(166,69,46,.48); }
...
.charter-page__actions { position:relative; z-index:1; display:flex; flex-wrap:wrap; gap:9px; margin:0 0 16px; }
...
.charter-page__folio { position:relative; z-index:1; min-width:0; }
...
.charter-page__history summary small,.charter-page__history a span { font-size:12px; }
@media(max-width:760px) { .charter-page__panel { padding:20px 18px 22px; }.charter-page__panel::after { display:none; }.charter-page__masthead { grid-template-columns:auto minmax(0,1fr); }.charter-page__edition { grid-column:1/-1; display:flex; flex-wrap:wrap; justify-items:start; align-items:center; gap:10px; text-align:left; }.charter-page__leaf { min-height:480px; padding:22px 30px 32px; } }
@media(max-width:480px) { .charter-page { padding-bottom:24px; }.charter-page__panel { padding:20px 14px; }.charter-page__masthead { gap:12px; }.charter-page__seal { width:46px; height:46px; font-size:22px; }.charter-page__eyebrow { font-size:10px; letter-spacing:.12em; }.charter-page__title h1 { font-size:28px; }.charter-page__title p { grid-column:1/-1; }.charter-page__actions > button { flex:1 1 auto; }.charter-page__leaf { padding:19px 22px 27px; outline-offset:-5px; }.charter-page__leaf::before { display:none; }.charter-page__history > div { grid-template-columns:1fr; } }
</style>
