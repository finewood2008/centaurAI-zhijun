...
const DEFINITIONS = Object.freeze({
  ...
  CLAIM_CODE_EXPIRED: ['临时认领码已过期，请联系管理员确认。', 'none'],
  DEVICE_AUTHORIZATION_NOT_ENABLED: ['设备认领与授权服务尚未开放，请联系管理员确认服务版本和配置。', 'none'],
  ...
  CLIENT_BUSY: ['客户端请求队列已满或等待过久。本次请求尚未发出，请稍后重试。', 'user_read'],
  BOX_BUSY: ['盒端正在处理较多任务，请等待当前任务完成后重试。', 'user_read'],
  WORKSPACE_STORAGE_FULL: ['盒端工作区任务记录或存储配额已满，请联系管理员检查任务回收与存储状态。', 'none'],
  REMOTE_RATE_LIMITED: ['盒端暂时限制了请求，请稍后重试；这不表示账号不能多端登录。', 'user_read'],
