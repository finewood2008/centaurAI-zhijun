...
function mapConnectionError(error, phase = 'native') {
  ...
  const mapping = {
    ...
    SDK_PATH_POLICY_FAILED: 'ACCESS_DENIED', REQUEST_TARGET_NOT_ALLOWED: 'ACCESS_DENIED',
    SDK_CONNECTION_CLOSED: 'CONNECTIVITY_SESSION_EXPIRED', IPC_SIDECAR_CLOSED: 'SESSION_NOT_READY',
  };
