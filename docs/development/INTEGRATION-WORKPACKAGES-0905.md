...
> 更新：2026-09-06。状态：M0-L 本地实现与隔离验证已完成，正式 SDK/服务端桥未接通，未签发正式应用权限、未连接真实盒子。原规划把 [集成方案](INTEGRATION-0905.md) 的 P0–P7 细化为可分工工作包；客户端接口以 [桌面接口合同](DESKTOP-CONTRACT-0905.md) 为准，部署边界以 [架构](ARCHITECTURE-0905.md) 为准。
...
| 正式应用身份、业务身份桥 | 已自动配置现有 PC 资料目标；macOS存储/原生sidecar通过；真实登录/业务桥未闭环 | WP-00、WP-02、WP-03 的部署配置和正负向结果 |
