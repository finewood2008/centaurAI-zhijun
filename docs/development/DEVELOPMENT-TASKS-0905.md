...
| BASE-03；DESK-15–23；SERV-01–20；CONN-01–18 | 未开始 | 正式认证/身份桥/真机、全域业务迁移、流/上传和发布继续按依赖推进 |
| BASE-02；DESK-04/05/06 | 实施中 / 客户端本地通过待外部验收 | 显式配置、正式密码登录/签名、系统加密存储、SDK共享刷新与设备票据已编码；真实注册、OS签名存储及服务部署待验 |
